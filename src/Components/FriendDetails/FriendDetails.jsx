...
const FriendDetails = () => {
    ...
    const {handleCallBtn, handleTextBtn, handleVideoBtn}= useContext(FriendsData)
    ...
    return (
        <div className='bg-sky-50 py-10'>
            <div className='max-w-[80%] mx-auto grid max-md:grid-cols-1 grid-cols-12 gap-5'>
                ...
                <div className='md:col-span-8 lg:col-span-8 space-y-5'>
                    ...
                    <div className='max-sm:flex-row bg-white w-full rounded-2xl p-5 space-y-2'>
                        ...
                        <div className='flex flex-wrap justify-center gap-2'>
                            <div> <button onClick={()=>handleCallBtn(friend)} className='btn w-50 h-20 flex flex-col items-center justify-center'><FiPhoneCall /> Call</button></div>
                            <div> <button onClick={()=>handleTextBtn(friend)} className='btn w-50 h-20 flex flex-col items-center justify-center'><MdOutlineTextsms /> Text</button></div>
                            <div><button  onClick={()=>handleVideoBtn(friend)} className='btn w-50 h-20 flex flex-col items-center justify-center'><GoDeviceCameraVideo /> Video</button></div>
                        </div>
                    </div>
                </div>
            </div>
